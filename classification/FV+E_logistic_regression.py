...
if __name__ == "__main__":
    ...
    model_save_path = r"C:/Users/paul-/Documents/Uni/Management and Digital Technologies/Thesis Fora/Code/data/random_forest_models_smoteenn.pkl"
    ...
    # explode the list of embeddings into separate rows
    data = data.explode("Latent-Attention_Embedding")
    data["Latent-Attention_Embedding"] = data["Latent-Attention_Embedding"].apply(
        np.array
    )
    ...
    # Extract embedding and split it into separate columns
    X_embedding = pd.DataFrame(data["Latent-Attention_Embedding"].tolist())

    # Combine scalar features and embedding columns
    X = pd.concat([X_scalar, X_embedding], axis=1)
